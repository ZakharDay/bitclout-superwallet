const getExchangeRate = 'https://bitclout.com/api/v0/get-exchange-rate'
const getBitcoinPrice = 'https://api.blockchain.com/ticker'
// prettier-ignore
const buyOrSellUrl = 'https://api.bitclout.com/buy-or-sell-creator-coin'
